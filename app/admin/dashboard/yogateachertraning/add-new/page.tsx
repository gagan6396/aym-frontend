        ...
        <div className={styles.sectionBlock}>
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={styles.inputWrap}>
              <textarea 
                className={`${styles.input} ${styles.textarea}`} 
                placeholder="🏅 Yoga Alliance USA — RYS 200 & 300, 🏛️ YCB — Ministry of AYUSH, Govt. of India, 🌍 International Yoga Federation" 
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={`${styles.inputWrap} ${errors.yogaStyles ? styles.inputError : ""} ${form.yogaStyles && !errors.yogaStyles ? styles.inputSuccess : ""}`}>
              <input 
                type="text" 
                className={styles.input} 
                placeholder="e.g. Hatha Yoga, Ashtanga Yoga, Kundalini Yoga, Vinyasa Flow, Yin Yoga, Restorative Yoga" 
          ...
          <div className={styles.fieldGroup}>
            ...
            <div className={`${styles.inputWrap} ${styles.inputWithPrefix} ${errors.ctaLink ? styles.inputError : ""} ${form.ctaLink && !errors.ctaLink ? styles.inputSuccess : ""}`}>
              ...
              <input 
                ...
                placeholder="/yoga-teacher-training or https://example.com/courses" 
                value={form.ctaLink} 
