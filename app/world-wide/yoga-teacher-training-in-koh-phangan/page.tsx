      ...
      <section className={styles.contentSection} id="content">
        ...
        <div className={styles.container}>
          ...
          <h2 className={styles.sectionTitle}>
            Yoga Teacher Training Koh Phangan
          </h2>
            ...
            <div className={styles.card}>
              <div className={styles.cardHeader}>
                ...
                <h4 className={styles.cardTitle}>
                  Choose The Top Yoga Teacher Training Program In Koh Phangan
                </h4>
              </div>
              <p className={styles.bodyText}>
                Yoga Is One Of The Best Practices That People End Up Choosing To
                Adopt A Life Of Peace, Calm And Tranquillity. With Each Passing
                Day, People Are Becoming Aware Of Its Importance And Are
                Choosing It Without A Second Thought. Some Focus On Learning It
                For Themselves, While Others Look Forward To Spreading Its
                Knowledge All Around. And For That, People Prefer To Choose Us
                At The Association For Yoga And Meditation For A 200 Hour Yoga
                Teacher Training Course In Koh Phangan. Anyone Interested In
                Becoming A Yoga Instructor Can Rely On Us As We Provide
                Individuals With The Best Yoga Instruction And Training. To
                Date, We Have Trained Thousands Of Pupils Through Our YTT In Koh
                Phangan, That Have Existed For Over A Decade.
              </p>
            </div>
          </div>
          ...
          <h3 className={styles.subTitle}>
            Why Is AYM The Best Location To Learn Yoga And Meditation?
          </h3>
          <p className={styles.bodyText}>
            If You Are Looking Forward To 300 Hours Yoga Teacher Training Course
            In Koh Phangan, Then Know That We Are Indeed The One-Stop Platform
            In Rishikesh To Help You Through. There Are Multiple Reasons Why We
            Are The Best Choice For Everyone Including:
          </p>
          ...
          <h3 className={styles.subTitle}>
            What Are The Benefits Of Learning Power Yoga?
          </h3>
          <p className={styles.bodyText}>
            It Is Crucial To Consider The Advantages It Will Have For You And
            The Students Who Will Be Studying Under You When You Wish To Launch
            A Successful Professional Career. Before Enrolling, Check Out The
            Following To Know The Significant Advantages Of Our 300-Hour Yoga
          ...
          <h3 className={styles.subTitle}>
            Understand Minute Details Of Yoga With Us At AYM
          </h3>
          <p className={styles.bodyText}>
            On Choosing Our Licensed Yoga Teacher Training Program In Koh
            Phangan, You Can Expect To Get A Detailed Review Or Learning Of How
            Yoga Began And Where It Lies Today. You Will Be Introduced To The
            Latest Aspects Of Yoga And Taught How You Could Transform Your Life
            Using It. As The Best Provider Of Registered Yoga Therapy Teacher
            Training Courses In Koh Phangan, We Ensure That You Are Molded To
            Become A True Professional. Also, You Will Be Trained To Deal With
            Students In The Future. Every Course Includes Different Topics
            Besides Assignments And Assessments. Once You Qualify, You Will Be
            Rewarded With The YTT International Certification.
          </p>
